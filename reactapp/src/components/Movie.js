...
function Movie(props) {
  /* Pour pouvoir initialiser un état à l’intérieur de notre composant, il faut importer la fonction (useState) permettant d'initialiser l’état et son setteur. Cette fonction est appelée Hook d’état */
  ...
  // 👉 Grâce à la mécanique des propriétés, faites transiter cette méthode aux différents composants Movie
